...
import { WOMEN_CATEGORIES, WOMEN_PRODUCTS } from '../data/mockData';
...
const Women = () => {
    ...
    const filteredProducts = activeCategory === "Todos"
        ...
        : activeCategory === "Novidades"
            ? WOMEN_PRODUCTS.filter(p => p.tag === "NOVO")
            : activeCategory === "Ofertas"
                ? WOMEN_PRODUCTS.filter(p => p.tag === "SALE")
                : WOMEN_PRODUCTS.filter(p => p.category === activeCategory);
